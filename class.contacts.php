...
class HubSpot_Contacts extends HubSpot_BaseClient {
	 ...
	 *
	 * @param params: array of properties and property values for new/updated contact, email is required
	 *
	 ...
	 * */
	public function create_update_contact($params) {
		$endpoint = 'contact/createOrUpdate/email/' . $params['email'];
		$properties = array();
